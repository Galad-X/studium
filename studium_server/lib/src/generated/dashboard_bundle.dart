...
import 'package:studium_server/src/generated/protocol.dart' as _i5;

abstract class DashboardBundle
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      '__className__': 'DashboardBundle',
      'history': history.toJsonForProtocol(),
      'recentMaterials': recentMaterials.toJson(
        valueToJson: (v) => v.toJsonForProtocol(),
      ),
      'recentSummaries': recentSummaries.toJson(
        valueToJson: (v) => v.toJsonForProtocol(),
      ),
    };
  }
